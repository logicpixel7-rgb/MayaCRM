...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Designed and Developed: Pixel Logic',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Mega Search',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Everything you need to get the most out of Maya Admin — hosting, support and professional services, plus extensions and developer documentation.',
            'contact-us' => 'Contact us',
            'view-all' => 'View all',
            'still-need-help-title' => 'Still need a hand?',
            'still-need-help-description' => 'Talk to the Maya team about hosting, custom development or anything else.',

            'services' => [
                'title' => 'Services & Resources',
                'cloud-hosting' => [
                    'title' => 'Cloud Hosting',
                    'description' => 'Cost-effective, managed cloud hosting — try and launch Maya on the cloud in minutes, fully optimised and scalable.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Extensions',
                    'description' => 'Browse official and community add-ons to extend Maya with new connectors, channels and features.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    'title' => 'API Docs',
                    'description' => 'Full REST API reference with endpoints, authentication and examples to integrate Maya with your stack.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Connect with thousands of other Maya users and developers to share tips and solve problems.',
