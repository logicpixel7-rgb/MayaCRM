...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desenvolvido por :maya, um projeto de código aberto da :Maya.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Busca rápida',
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Tudo o que você precisa para aproveitar ao máximo o Maya Admin — hospedagem, suporte e serviços profissionais, além de extensões e documentação para desenvolvedores.',
            'contact-us' => 'Fale conosco',
            'view-all' => 'Ver tudo',
            'still-need-help-title' => 'Ainda precisa de ajuda?',
            'still-need-help-description' => 'Fale com a equipe Maya sobre hospedagem, desenvolvimento personalizado ou qualquer outra coisa.',

            'services' => [
                'title' => 'Serviços e recursos',
                'cloud-hosting' => [
                    'title' => 'Hospedagem na nuvem',
                    'description' => 'Hospedagem na nuvem gerenciada e econômica — experimente e coloque o Maya na nuvem em minutos, totalmente otimizado e escalável.',
                ],
                'support' => [
                ...
                'extensions' => [
                    'title' => 'Extensões',
                    'description' => 'Navegue por complementos oficiais e da comunidade para ampliar o Maya com novos conectores, canais e recursos.',
                ],
            ],
            ...
            'resources' => [
                ...
                'api-docs' => [
                    ...
                    'description' => 'Referência completa da API REST com endpoints, autenticação e exemplos para integrar o Maya ao seu stack.',
                ],
            ],
            ...
            'community' => [
                'forums' => [
                    ...
                    'description' => 'Conecte-se com milhares de outros usuários e desenvolvedores do Maya para compartilhar dicas e resolver problemas.',
