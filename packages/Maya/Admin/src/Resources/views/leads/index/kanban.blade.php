    ...
    >
        ...
        <template v-else>
            <div class="flex flex-col gap-4">
                ...
                <div class="grid grid-cols-3 gap-4 overflow-x-auto max-h-[calc(100vh-300px)]">
                    <!-- Stage Cards -->
                    <div
                        class="flex min-w-[275px] max-w-[300px] flex-col gap-1 rounded-lg border border-gray-300 bg-white dark:border-gray-800 dark:bg-gray-900"
