    ...
    <div class="flex h-[100vh] flex-col items-center justify-center gap-10">
        ...
        <div class="text-sm font-normal">
            @lang('admin::app.components.layouts.powered-by.description', [
                'Pixel Logic' => '<a class="text-brandColor hover:underline" href="https://pxlg.vercel.app/">Pixel Logic</a>',
                'Maya' => '<a class="text-brandColor hover:underline " href="https://Maya.com/">Maya</a>',
            ]) 
        </div>
    </div>
