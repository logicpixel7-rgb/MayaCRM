@php($placeholders = app('\Maya\Automation\Helpers\Entity')->getEmailTemplatePlaceholders())

<v-tinymce {{ $attributes }}></v-tinymce>

@pushOnce('scripts')
    <!--
        TODO (@devansh-Maya): Only this portion is pending; it just needs to be integrated using the Vite bundler. Currently,
