...
use Maya\Admin\Bouncer;
use Maya\Admin\Exceptions\Handler;
use Maya\Admin\Http\Middleware\Bouncer as BouncerMiddleware;
use Maya\Admin\Http\Middleware\Locale;
use Maya\Admin\Http\Middleware\SanitizeUrl;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    protected function registerFacades(): void
    {
        ...
        $loader->alias('Bouncer', \Maya\Admin\Facades\Bouncer::class);
