    ...
    [
        ...
        'fields' => [
            [
                ...
                'type' => 'select',
                'default' => 'en',
                'options' => 'Maya\Core\Core@locales',
            ],
        ],
    ], [
        ...
        'fields' => [
            [
                ...
                'type' => 'editor',
                'default' => 'Design and Development by <span style="color: rgb(14, 144, 217);"><a href="https://pxlg.vercel.app/" target="_blank">Pixel Logic</a></span>.',
                'tinymce' => true,
            ],
        ],
    ], [
