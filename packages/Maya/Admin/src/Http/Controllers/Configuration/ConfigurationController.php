...
namespace Maya\Admin\Http\Controllers\Configuration;
...
use Maya\Admin\Http\Requests\ConfigurationForm;
use Maya\Core\Repositories\CoreConfigRepository as ConfigurationRepository;
