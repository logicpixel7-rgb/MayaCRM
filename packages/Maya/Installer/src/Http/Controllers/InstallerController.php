...
namespace Maya\Installer\Http\Controllers;
...
use Maya\Installer\Helpers\DatabaseManager;
use Maya\Installer\Helpers\EnvironmentManager;
use Maya\Installer\Helpers\ServerRequirements;
...
class InstallerController extends Controller
{
    ...
    private function smtpConfigSetup()
    {
        ...
        File::put($filePath, 'Your Maya App is Successfully Installed');
