    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'maya' => 'نصب کرایین',
                'maya-info' => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title' => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel' => 'پنل مدیریت',
                'maya-forums' => 'انجمن کرایین',
                'customer-panel' => 'پنل مشتری',
                'explore-maya-extensions' => 'کاوش افزونه‌های کرایین',
                'title' => 'نصب کامل شد',
            ...
            'back' => 'بازگشت',
            'maya' => 'کرایین',
            'maya-info' => 'یک پروژه اجتماعی توسط',
            'maya-logo' => 'لوگوی کرایین',
            'continue' => 'ادامه',
