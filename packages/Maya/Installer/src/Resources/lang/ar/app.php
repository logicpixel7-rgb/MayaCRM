    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'maya' => 'تثبيت Maya',
                'maya-info' => 'إنشاء جداول قاعدة البيانات، وقد يستغرق ذلك بضع دقائق',
                'title' => 'التثبيت',
            ],

            'installation-completed' => [
                'admin-panel' => 'لوحة المشرف',
                'maya-forums' => 'منتديات Maya',
                'customer-panel' => 'لوحة العميل',
                'explore-maya-extensions' => 'استكشاف امتدادات Maya',
                'title' => 'اكتمال التثبيت',
                'title-info' => 'تم تثبيت Maya بنجاح على نظامك.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'إنشاء جدول قاعدة البيانات',
                'install' => 'التثبيت',
                'install-info' => 'Maya للتثبيت',
            ...
            'start' => [
                ...
                'title' => 'تثبيت Maya الخاص بك',
                'welcome-title' => 'مرحبًا بك في Maya',
            ],
            ...
            'back' => 'رجوع',
            'maya' => 'Maya',
            'maya-info' => 'مشروع مجتمعي من قبل',
            'maya-logo' => 'شعار Maya',
            'continue' => 'متابعة',
            'installation-description' => 'عادة ما تتضمن عملية تثبيت Maya عدة خطوات. إليك نظرة عامة عامة على عملية التثبيت maya',
