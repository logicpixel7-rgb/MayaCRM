    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'maya' => 'Instalação do Maya',
                'maya-info' => 'Criando as tabelas do banco de dados, isso pode levar alguns momentos',
                'title' => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel' => 'Painel de Administração',
                'maya-forums' => 'Fórum Maya',
                'customer-panel' => 'Painel do Cliente',
                'explore-maya-extensions' => 'Explorar Extensões Maya',
                'title' => 'Instalação Concluída',
                'title-info' => 'Maya foi instalado com sucesso no seu sistema.',
            ],
            ...
            'start' => [
                ...
                'title' => 'Instalação do Maya',
                'welcome-title' => 'Bem-vindo ao Maya',
            ],
            ...
            'back' => 'Voltar',
            'maya' => 'Maya',
            'maya-info' => 'um projeto comunitário de',
            'maya-logo' => 'Logotipo Maya',
            'continue' => 'Continuar',
            'installation-description' => 'A instalação do Maya geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do Maya',
