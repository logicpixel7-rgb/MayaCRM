    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'maya' => 'Instalación de Maya',
                'maya-info' => 'Creando las tablas de la base de datos, esto puede tardar unos momentos',
                'title' => 'Instalación',
            ],

            'installation-completed' => [
                'admin-panel' => 'Panel de Administración',
                'maya-forums' => 'Foro de Maya',
                'customer-panel' => 'Panel de Clientes',
                'explore-maya-extensions' => 'Explorar Extensiones de Maya',
                'title' => 'Instalación Completada',
                'title-info' => 'Maya se ha instalado correctamente en su sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'Crear tabla de base de datos',
                'install' => 'Instalación',
                'install-info' => 'Maya Para la Instalación',
            ...
            'start' => [
                ...
                'title' => 'Instalación de Maya',
                'welcome-title' => 'Bienvenido a Maya',
            ],
            ...
            'back' => 'Atrás',
            'maya' => 'Maya',
            'maya-info' => 'un Proyecto Comunitario de',
            'maya-logo' => 'Logotipo de Maya',
            'continue' => 'Continuar',
            'installation-description' => 'La instalación de Maya generalmente implica varios pasos. Aquí hay un esquema general del proceso de instalación de Maya.',
