...
namespace Maya\Installer\Events;
...
class ComposerEvents
{
    ...
    /**
     * Build the Maya Cloud Hosting promotional box for the console output.
     *
     * @return string
     */
    public static function cloudHostingBox()
    {
        ...
        $lines = [
            ['★ Maya CLOUD HOSTING', 'fg=#facc15;options=bold'],
            ['', 'fg=#ffffff'],
            ['Skip the server setup — run Maya on fast, secure,', 'fg=#ffffff'],
            ...
            ['', 'fg=#ffffff'],
            ['→ https://pxlg.vercel.app/crm-cloud-hosting/', 'fg=#bae6fd;options=bold'],
        ];
