...
namespace Maya\Installer\Console\Commands;
...
use Maya\Installer\Events\ComposerEvents;
...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'maya-crm:install
     ...
     * @var string
     */
    protected $description = 'Maya installer.';
    ...
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for Maya kickstart...');
        $this->info(app(MayaDatabaseSeeder::class)->run([
    ...
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'Maya is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use Maya.');
            $this->info('Go to '.env('APP_URL').'/admin/dashboard'.' and authenticate with:');
            $this->info('Email: '.$adminEmail);
            $this->info('Password: '.$adminPassword);
            $this->info('Cheers!');

            Event::dispatch('maya.installed');
        } catch (\Exception $e) {
