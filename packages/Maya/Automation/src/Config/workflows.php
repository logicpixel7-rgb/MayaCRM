...
return [
    'trigger_entities' => [
        ...
        'leads' => [
            'name' => 'Leads',
            'class' => 'Maya\Automation\Helpers\Entity\Lead',
            'events' => [
                [
        ...
        'activities' => [
            'name' => 'Activities',
            'class' => 'Maya\Automation\Helpers\Entity\Activity',
            'events' => [
                [
        ...
        'persons' => [
            'name' => 'Persons',
            'class' => 'Maya\Automation\Helpers\Entity\Person',
            'events' => [
                [
        ...
        'quotes' => [
            'name' => 'Quotes',
            'class' => 'Maya\Automation\Helpers\Entity\Quote',
            'events' => [
                [
