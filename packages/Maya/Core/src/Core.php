...
use Maya\Core\Repositories\CoreConfigRepository;
use Maya\Core\Repositories\CountryRepository;
use Maya\Core\Repositories\CountryStateRepository;
...
class Core
{
    ...
    /**
     * Get the version number of the Maya.
     *
     * @return string
     */
