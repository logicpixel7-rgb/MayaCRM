...
use Maya\Core\Acl;
use Maya\Core\Console\Commands\Version;
use Maya\Core\Core;
use Maya\Core\Facades\Acl as AclFacade;
use Maya\Core\Facades\Core as CoreFacade;
use Maya\Core\Facades\Menu as MenuFacade;
use Maya\Core\Facades\SystemConfig as SystemConfigFacade;
use Maya\Core\Menu;
use Maya\Core\SystemConfig;
