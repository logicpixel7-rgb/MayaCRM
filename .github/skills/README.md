...
| Skill | Use when |
|-------|----------|
| `crm-package-development` | Creating a new Maya CRM package/module or extending CRM functionality without touching core files. |
| `pest-testing` | Writing or debugging Maya CRM unit/feature tests with Pest. |
